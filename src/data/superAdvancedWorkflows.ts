...
export const SUPER_ADVANCED_WORKFLOWS: SuperAdvancedWorkflowDef[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    nodes: [
      ...
      { id: 'c1_n13', name: '[OPS ALERT] Telegram Ops Notification', type: 'n8n-nodes-base.telegram', description: 'Notifica al panel central de operaciones de Costa Rica Tours el nuevo circuito multi-día' },
    ...
    blueprintJson: {
      ...
      nodes: [
        ...
        { parameters: { chatId: "-1002348576921", text: "=*🗺️ CIRCUITO MULTIDÍA AUTÓNOMO CREADO*=\n\nCliente: Carlos Robinson (4 pax)\nRuta: SJO ➔ Arenal ➔ Monteverde ➔ Manuel Antonio\nTransporte: Alsama Tours CR Van Ejecutiva", additionalFields: { parse_mode: "Markdown" } }, name: "[OPS ALERT] Telegram Ops Notification", type: "n8n-nodes-base.telegram", typeVersion: 1.1, position: [2260, 300], credentials: { telegramApi: GOOGLE_SERVICE_ACCOUNT_CREDENTIAL } },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    nodes: [
      ...
      { id: 'c2_n11', name: '[TELEGRAM] Yield Analytics Alert', type: 'n8n-nodes-base.telegram', description: 'Envía informe de optimización al equipo comercial con incremento de ingresos proyectado' },
    ...
    blueprintJson: {
      ...
      nodes: [
        ...
        { parameters: { chatId: "-1002348576921", text: "=*📈 DYNAMIC PRICING EJECUTADO*=\n\nRegión: Arenal / La Fortuna\nTours Optimizados: 4\nPromedio Descuento: 12% Last-Minute\nBundle Activo: Tour + Alsama Tours Transfer", additionalFields: { parse_mode: "Markdown" } }, name: "[TELEGRAM] Yield Analytics Alert", type: "n8n-nodes-base.telegram", typeVersion: 1.1, position: [1700, 300], credentials: { telegramApi: GOOGLE_SERVICE_ACCOUNT_CREDENTIAL } },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    nodes: [
      ...
      { id: 'c3_n13', name: '[TELEGRAM] Emergency Command Center Broadcast', type: 'n8n-nodes-base.telegram', description: 'Alerta a la mesa de operaciones con la lista de turistas protegidos y choferes avisados' },
    ...
    blueprintJson: {
      ...
      nodes: [
        ...
        { parameters: { chatId: "-1002348576921", text: "=*🚨 CONTINGENCIA CLIMÁTICA ACTIVADA*=\n\nAlerta: Naranja Sarapiquí\nTuristas Protegidos: 12\nActividad Reemplazada: Rafting ➔ Tabacón Termales\nChoferes Alsama: Re-direccionados sin incidentes", additionalFields: { parse_mode: "Markdown" } }, name: "[TELEGRAM] Emergency Command Center Broadcast", type: "n8n-nodes-base.telegram", typeVersion: 1.1, position: [1300, 300], credentials: { telegramApi: GOOGLE_SERVICE_ACCOUNT_CREDENTIAL } },
