    ...
    <section className="py-16 bg-gradient-to-b from-neutral-50 via-emerald-50/20 to-white border-y border-neutral-100" id="traveler-toolkit">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="bg-emerald-100 text-emerald-800 text-[11px] font-black uppercase px-3.5 py-1 rounded-full border border-emerald-200 inline-flex items-center gap-1.5 shadow-sm">
            <Sparkles className="w-3.5 h-3.5 text-teal-600" />
            {isEs ? 'Guía Oficial & Herramientas del Viajero' : 'Official Costa Rica Traveler Toolkit'}
          </span>
          <h2 className="text-3xl sm:text-4xl font-black text-emerald-950 uppercase tracking-tight">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-neutral-200 shadow-sm space-y-8 animate-in fade-in duration-300">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-200 pb-5">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-emerald-800 hover:bg-emerald-900 text-white text-xs font-black px-4 py-2.5 rounded-full shadow transition-colors cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-emerald-50/70 p-5 rounded-2xl border border-emerald-200 space-y-3">
                <div className="w-10 h-10 rounded-xl bg-emerald-200 text-emerald-900 flex items-center justify-center font-black">
                  🎫
                </div>
                ...
                <div className="text-[11px] font-bold text-emerald-900 bg-white/80 p-2 rounded-lg border border-emerald-300">
              ...
              <div className="bg-amber-50/70 p-5 rounded-2xl border border-amber-200 space-y-3">
                ...
                <div className="text-[11px] font-bold text-amber-900 bg-white/80 p-2 rounded-lg border border-amber-300">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
                        <span className={`font-bold text-xs ${isChecked ? 'line-through text-emerald-900/70' : 'text-neutral-900'}`}>
        ...
        {activeTab === 'seasons' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in duration-300">
            ...
            {/* Dry Season */}
            <div className="bg-white p-6 rounded-3xl border border-neutral-200 shadow-sm space-y-4 hover:border-amber-500 transition-colors">
            ...
            {/* Green Season */}
            <div className="bg-white p-6 rounded-3xl border border-neutral-200 shadow-sm space-y-4 hover:border-amber-500 transition-colors">
              <div className="w-12 h-12 bg-emerald-100 text-teal-600 rounded-2xl flex items-center justify-center font-black">
              ...
              <div className="bg-emerald-50 p-3 rounded-2xl border border-emerald-200 text-emerald-900 text-xs font-semibold">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-neutral-200 shadow-sm space-y-6 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-emerald-50 p-4 rounded-2xl border border-emerald-200 space-y-3 text-xs text-emerald-900">
                  ...
                  <div className="pt-2 border-t border-emerald-200/60 font-bold flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-3 py-2 bg-white border border-neutral-300 rounded-xl font-black text-emerald-900 text-lg"
                    />
                  </div>
                </div>
