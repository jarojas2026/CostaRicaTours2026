    ...
    <section className="relative bg-transparent text-stone-900 overflow-hidden py-12 lg:py-20 border-b border-stone-200/50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-950/80 text-emerald-300 rounded-full text-sm font-bold uppercase tracking-widest border border-emerald-500/40 backdrop-blur-md">
            ...
            <p className="text-lg sm:text-xl text-emerald-100/90 max-w-2xl font-medium leading-relaxed drop-shadow-md">
              {language === 'es' 
            ...
            <div className="bg-[#07241a]/90 backdrop-blur-2xl p-4 sm:p-5 rounded-[2rem] border border-emerald-500/30 shadow-[0_10px_40px_rgba(0,0,0,0.6)] space-y-3 mt-6">
              ...
              <div className="flex flex-wrap sm:flex-nowrap gap-3 pt-1">
                ...
                <button
                  ...
                  className="w-full sm:w-auto flex-1 bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-500/40 backdrop-blur-md text-white font-extrabold text-sm uppercase py-3.5 px-6 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-emerald-950/50 hover:bg-emerald-900/70 text-emerald-100 font-bold text-sm py-3.5 px-6 rounded-xl border border-emerald-500/30 transition-colors flex items-center justify-center gap-2 shadow-sm cursor-pointer"
                >
              ...
              <div className="pt-2 border-t border-black/10 flex items-center gap-2 flex-wrap text-xs">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-full bg-emerald-950/60 hover:bg-amber-500 hover:text-stone-950 border border-emerald-500/40 text-emerald-200 transition-colors cursor-pointer"
                >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-stone-950/80 via-stone-950/40 to-transparent flex flex-col justify-end p-8">
                    ...
                    <p className="text-xs sm:text-sm text-stone-200 mb-4 drop-shadow line-clamp-3">
                      {language === 'es' ? slide.desc : slide.descEn}
                    </p>
                    <div className="flex items-center justify-between border-t border-black/20 pt-4">
                      <div className="flex flex-col">
                         <span className="text-[10px] text-stone-300 font-bold uppercase">{language === 'es' ? 'Desde ' : 'From '}</span>
                         <span className="text-xl sm:text-2xl font-black text-amber-400">
                           {formatCurrency(Number(slide.price.replace(/[^0-9]/g, '')) || 0, currency)}
                         </span>
                      </div>
                      <button className="bg-amber-500 hover:bg-amber-400 text-stone-950 font-black px-4 sm:px-6 py-2 sm:py-2.5 rounded-full text-[10px] sm:text-xs uppercase tracking-wider transition-colors shadow-lg">
