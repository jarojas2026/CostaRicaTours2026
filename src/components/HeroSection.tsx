...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative bg-transparent text-white overflow-hidden py-12 lg:py-20 border-b border-emerald-900/50">
      {/* Background decoration & atmospheric glow */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-emerald-950/80 to-transparent pointer-events-none" />
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-900/60 text-emerald-100 rounded-full text-sm font-bold uppercase tracking-widest border border-emerald-500/30 backdrop-blur-md">
            ...
            <p className="text-lg sm:text-xl text-emerald-50 max-w-2xl font-medium leading-relaxed drop-shadow-md">
              {language === 'es' 
            ...
            <div className="flex flex-wrap items-center gap-6 pt-2">
              <div className="flex flex-col">
                <span className="text-3xl sm:text-4xl font-black text-amber-400">+12,000</span>
                <span className="text-[11px] uppercase font-bold text-emerald-100 opacity-90">
                  {t('happyTravelers')}
                </span>
              </div>
              <div className="hidden sm:block w-[1px] h-10 bg-emerald-700/60" />
              <div className="flex flex-col">
                <span className="text-3xl sm:text-4xl font-black text-amber-400">4.95 ★</span>
                <span className="text-[11px] uppercase font-bold text-emerald-100 opacity-90">
                  {t('verifiedReviews')}
                </span>
              </div>
              ...
              <div className="hidden sm:block w-[1px] h-10 bg-emerald-700/60" />
              <div className="flex flex-col">
                <span className="text-3xl sm:text-4xl font-black text-green-400">ECO</span>
                <span className="text-[11px] uppercase font-bold text-emerald-100 opacity-90">
                  {language === 'es' ? 'Certificado Sostenible' : 'Certified Sustainable'}
                </span>
              </div>
            </div>

            {/* Search and Filters Bar */}
            <div className="bg-emerald-900/10 backdrop-blur-md p-4 sm:p-5 rounded-[2rem] border border-white/10 shadow-2xl space-y-3 mt-6">
              <div className="text-xs uppercase font-extrabold text-amber-300 tracking-wider flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-emerald-950/20 text-white placeholder-emerald-100/60 text-sm px-4 py-3.5 rounded-xl border border-white/10 focus:outline-none focus:border-amber-400 transition-colors"
                  />
                </div>
                ...
                <select
                  ...
                  className="w-full bg-emerald-950/40 text-emerald-50 text-sm px-4 py-3.5 rounded-xl border border-white/10 focus:outline-none focus:border-amber-400 transition-colors cursor-pointer appearance-none"
                >
              ...
              <div className="flex flex-wrap sm:flex-nowrap gap-3 pt-1">
                {onOpenCustomFunnel && (
                  <button
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-teal-600 to-teal-600 hover:from-amber-500 hover:to-amber-500 text-white font-black text-sm uppercase py-3.5 px-6 rounded-xl shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2 cursor-pointer"
                  >
              ...
              <div className="pt-2 border-t border-white/10 flex items-center gap-2 flex-wrap text-xs">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-full bg-emerald-950/60 hover:bg-amber-500 hover:text-white border border-emerald-500/30 text-emerald-200 transition-colors cursor-pointer"
                >
          ...
          >
            <div className="absolute inset-0 bg-white/[0.03] rounded-[3rem] border border-neutral-100 overflow-hidden shadow-2xl group cursor-pointer">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/80 via-emerald-950/40 to-transparent flex flex-col justify-end p-8">
                    <span className="bg-amber-500 text-white text-[10px] font-black uppercase px-3 py-1 rounded-full shadow-lg w-fit mb-3">
                    ...
                    <p className="text-xs sm:text-sm text-emerald-50 mb-4 drop-shadow line-clamp-3">
                    ...
                    <div className="flex items-center justify-between border-t border-white/20 pt-4">
                      <div className="flex flex-col">
                         ...
                         <span className="text-xl sm:text-2xl font-black text-amber-400">{slide.price} USD</span>
                      </div>
              ...
              {HERO_SLIDES.map((_, index) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    currentSlide === index ? 'w-8 bg-[#FFD700]' : 'w-2 bg-emerald-900/40 hover:bg-emerald-900/60'
                  }`}
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-emerald-950/30 hover:bg-emerald-950/50 text-white rounded-full flex items-center justify-center backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-white/10"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-emerald-950/30 hover:bg-emerald-950/50 text-white rounded-full flex items-center justify-center backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-white/10"
            >
