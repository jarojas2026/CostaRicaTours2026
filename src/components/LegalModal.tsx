      ...
      <div className="bg-white text-stone-900 rounded-[2rem] w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl border border-black/10 relative overflow-hidden">
        ...
        <div className="p-6 border-b border-black/10 flex items-center justify-between shrink-0 bg-stone-100/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white border border-black/10 rounded-full flex items-center justify-center shadow-inner">
        ...
        <div className="flex flex-col sm:flex-row flex-1 min-h-0">
          {/* Tabs Sidebar */}
          <div className="sm:w-64 border-r border-black/10 p-4 space-y-2 shrink-0 overflow-x-auto sm:overflow-y-auto flex sm:flex-col">
            <button
            ...
            <div className="prose prose-invert prose-emerald max-w-none text-sm space-y-6">
              ...
              {activeTab === 'cancelacion' && (
                <>
                  ...
                  <div className="overflow-x-auto mt-4 mb-6 rounded-xl border border-black/10 bg-white/5">
                    <table className="w-full text-left text-sm text-stone-700">
                      <thead className="bg-white/5 font-bold">
                        <tr>
                          <th className="px-4 py-3 border-b border-black/10">Antelación de la cancelación</th>
                          <th className="px-4 py-3 border-b border-black/10">Condición de reembolso</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="px-4 py-3 border-b border-black/5">Más de 48 horas antes del tour</td>
                          <td className="px-4 py-3 border-b border-black/5 text-orange-400 font-bold">Devolución del 100% del depósito, menos gastos administrativos</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 border-b border-black/5">Entre 24 y 48 horas antes del tour</td>
                          <td className="px-4 py-3 border-b border-black/5 text-orange-400 font-bold">Se retiene el 50% del valor total del servicio</td>
                        </tr>
                        <tr>
                  ...
                  <p className="text-stone-700 mb-2">Si el tour debe cancelarse por causas de fuerza mayor, clima extremo, cierre temporal del parque por disposición SINAC o cualquier causa ajena a la voluntad del cliente, se ofrecerán tres alternativas:</p>
                  ...
                  <p className="text-stone-700">Las modificaciones solicitadas por el cliente estarán sujetas a disponibilidad de cupos y al ajuste de precio correspondiente. No se garantiza la misma tarifa si la solicitud se realiza con menos de 7 días de antelación.</p>

                  <h4 className="text-lg font-bold text-orange-300 mt-6 mb-2">Disputas de pago (contracargos / chargebacks)</h4>
                  <p className="text-stone-700">No se aceptarán solicitudes de reembolso mediante contracargo bancario cuando el servicio haya sido prestado conforme a lo contratado. Cualquier reclamo deberá presentarse por escrito durante o inmediatamente después de la realización del tour, según lo establecido en los Términos y Condiciones.</p>
                </>
              )}
              ...
              {activeTab === 'escnna' && (
                <>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 p-6 rounded-2xl mb-6">
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-stone-700 mb-4 font-bold">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-white/[0.03] p-4 rounded-xl border border-black/10">
                      
                      <p className="text-lg font-black text-white">#1042</p>
                    </div>
                    <div className="bg-white/[0.03] p-4 rounded-xl border border-black/10">
                      <p className="text-[10px] text-stone-600 font-bold uppercase mb-1">Seguro Responsabilidad Civil</p>
