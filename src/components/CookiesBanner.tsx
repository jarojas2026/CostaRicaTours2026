...
export const CookiesBanner: React.FC<CookiesBannerProps> = ({ language }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[110] bg-stone-950 border-t border-orange-500/30 p-4 sm:p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] animate-in slide-in-from-bottom-full duration-500">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        
        <div className="flex items-start gap-4 max-w-3xl">
          <div className="w-10 h-10 rounded-full bg-stone-900/50 border border-orange-500/30 flex items-center justify-center shrink-0 shadow-lg">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-stone-100/80 text-xs leading-relaxed">
              {language === 'es' 
