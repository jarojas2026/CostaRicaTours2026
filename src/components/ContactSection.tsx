        ...
        <div>
          ...
          <div className="mt-12 flex gap-4">
            {[Instagram, Facebook, Twitter].map((Icon, i) => (
              <button key={i} className="w-10 h-10 rounded-full bg-stone-900 border border-white/5 flex items-center justify-center text-stone-400 hover:text-emerald-400 hover:border-emerald-500/50 transition-all">
        ...
        >
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              ...
              <select className="w-full bg-stone-950/50 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-emerald-500 transition-colors appearance-none">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                rows={4}
                className="w-full bg-stone-950/50 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-emerald-500 transition-colors"
                placeholder={language === 'es' ? 'Cuéntanos tu plan...' : 'Tell us your plan...'}
              />
            </div>

            <button className="w-full bg-emerald-500 hover:bg-emerald-400 text-stone-950 font-black py-5 rounded-2xl shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-3 transition-all transform hover:-translate-y-1 active:translate-y-0">
