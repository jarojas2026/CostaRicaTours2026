  ...
  const handleCreateTestAlert = async (severity: 'critical' | 'warning' | 'info') => {
    ...
    try {
      ...
      const res = await fetch('/api/alerts', {
        ...
        body: JSON.stringify({
          source: 'native-automation Workflow • Pagos Automáticos a Proveedores',
          severity,
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-slate-300 max-w-2xl">
              Canal unificado que reemplaza Telegram. Recibe fallos, anomalías de pago SINPE/Stripe y estados críticos de los workflows de native-automation con persistencia en Firestore y alertas automáticas por correo.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              title="Simular fallo crítico de native-automation"
            >
        ...
        {loading ? (
          ...
          <div className="p-12 text-center bg-slate-900/40 border border-slate-800 rounded-2xl">
            ...
            <p className="text-xs text-slate-400 max-w-sm mx-auto">
              Todos los workflows de native-automation, verificaciones SINPE y notificaciones a operadores están operando con normalidad.
            </p>
          </div>
        ) : (
                    ...
                    <div className="space-y-1.5 flex-1 min-w-0">
                      ...
                      {isExpanded && alert.metadata && Object.keys(alert.metadata).length > 0 && (
                        <div className="mt-3 p-3 bg-slate-950 rounded-lg border border-slate-800 text-[11px] font-mono text-slate-400 overflow-x-auto">
                          <div className="font-bold text-slate-300 mb-1">Metadatos native-automation:</div>
