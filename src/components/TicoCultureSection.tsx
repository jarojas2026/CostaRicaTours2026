...
export const TicoCultureSection: React.FC<TicoCultureSectionProps> = ({ language, onExploreTours }) => {
  ...
  return (
    <section id="tico-culture-section" className="py-16 bg-[#071A0F]/90 text-white relative overflow-hidden border-y border-teal-500/30">
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {filteredSlang.map((item, idx) => (
                <div 
                  key={idx}
                  className="bg-[#0E351F]/90 rounded-3xl p-6 border border-teal-500/30 shadow-xl hover:border-orange-400 transition-all space-y-4 flex flex-col justify-between"
                >
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {TICO_DISHES.map((dish, index) => (
                <div 
                  key={index}
                  className="bg-[#0E351F]/90 rounded-3xl overflow-hidden border border-teal-500/30 shadow-xl hover:border-orange-400 transition-all flex flex-col group"
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-[#071A0F]/80 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-orange-300 border border-teal-500/30 flex items-center gap-1.5">
                      <span>{dish.icon}</span>
            ...
            {/* Salsa Lizano Note */}
            <div className="bg-[#0E351F] p-6 rounded-3xl border border-orange-500/30 flex flex-col md:flex-row items-center gap-6 max-w-4xl mx-auto">
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-gradient-to-br from-[#1b2b1a] to-[#0d2113] p-6 sm:p-8 rounded-3xl border border-orange-500/40 shadow-2xl grid md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-7 space-y-4">
                <div className="inline-flex items-center gap-2 bg-orange-500/20 text-orange-300 px-3 py-1 rounded-full text-xs font-black uppercase border border-orange-500/30">
              ...
              <div className="md:col-span-5 relative">
                <div className="bg-[#071A0F] p-6 rounded-3xl border border-teal-500/30 text-center space-y-4">
        ...
        {activeSubTab === 'symbols' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Perezoso */}
              <div className="bg-[#0E351F] p-6 rounded-3xl border border-teal-500/30 space-y-3">
        ...
        {activeSubTab === 'tips' && (
          <div className="space-y-6 animate-in fade-in duration-300 max-w-4xl mx-auto">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-[#0E351F] p-5 rounded-3xl border border-teal-500/30 space-y-2">
