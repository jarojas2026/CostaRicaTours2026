...
export const TicoCultureSection: React.FC<TicoCultureSectionProps> = ({ language, onExploreTours }) => {
  ...
  return (
    <section id="tico-culture-section" className="py-16 bg-[#041710]/90 text-white relative overflow-hidden border-y border-emerald-500/25">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-10">
          <div className="inline-flex items-center gap-2 bg-stone-100/80 text-amber-400 text-xs font-black uppercase px-4 py-1.5 rounded-full border border-orange-500/40 shadow-md">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-10">
          <button
            ...
            className={`px-4 sm:px-6 py-3 rounded-2xl font-black text-xs uppercase transition-all flex items-center gap-2 cursor-pointer ${
              activeSubTab === 'slang'
                ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-stone-950 shadow-lg scale-105 border border-amber-300'
                : 'bg-[#08241b] text-emerald-100 hover:bg-[#0c3527] hover:text-white border border-emerald-500/30'
            }`}
          >
        ...
        {activeSubTab === 'slang' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mb-6">
              <span className="text-xs text-teal-300 font-bold mr-2 uppercase">
                ...
                <button
                  ...
                  className={`text-xs px-3.5 py-1.5 rounded-full font-bold uppercase transition-colors ${
                    slangFilter === cat.id
                      ...
                      : 'bg-[#08241b] text-emerald-200 hover:bg-[#0c3527] hover:text-white border border-emerald-500/30'
                  }`}
                >
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-black text-amber-400">{item.word}</span>
                      <button
                        onClick={() => speakText(item.word)}
                        className="w-9 h-9 rounded-full bg-emerald-900/80 hover:bg-emerald-800 text-amber-400 flex items-center justify-center transition-transform active:scale-90 border border-emerald-500/40"
                    ...
                    <div className="text-[11px] font-mono text-teal-400 font-bold bg-emerald-950/80 border border-emerald-500/30 px-2.5 py-1 rounded-lg w-fit">
                  ...
                  <div className="bg-[#041710] p-3.5 rounded-2xl border border-emerald-500/20 space-y-1">
            ...
            <div className="bg-amber-950/30 p-5 rounded-3xl border border-orange-500/40 text-center max-w-2xl mx-auto space-y-2">
              ...
              {TICO_DISHES.map((dish, index) => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-[#041710]/80 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-amber-400 border border-emerald-500/25 flex items-center gap-1.5">
                      <span>{dish.icon}</span>
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div className="pt-4 border-t border-emerald-500/20 flex items-center justify-between text-[11px] text-teal-300">
                      <span className="font-bold flex items-center gap-1">
                        <CheckCircle2 className="w-3.5 h-3.5 text-amber-400" />
                        {language === 'es' ? '100% Sabor Criollo' : '100% Authentic Recipe'}
                      </span>
                      <span className="bg-white px-2 py-0.5 rounded-full font-mono text-[10px] text-amber-400">
        ...
        {activeSubTab === 'coffee' && (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-gradient-to-br from-[#1b2b1a] to-[#0d2113] p-6 sm:p-8 rounded-3xl border border-orange-500/40 shadow-2xl grid md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-7 space-y-4">
                <div className="inline-flex items-center gap-2 bg-orange-500/20 text-amber-400 px-3 py-1 rounded-full text-xs font-black uppercase border border-orange-500/30">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-[#041710] p-3 rounded-2xl border border-emerald-500/20">
              ...
              <div className="md:col-span-5 relative">
                <div className="bg-[#041710] p-6 rounded-3xl border border-emerald-500/25 text-center space-y-4">
                  <span className="text-5xl">☕🪵</span>
                  <h4 className="text-lg font-black text-amber-400 uppercase">
                    {language === 'es' ? '¿Cómo pedir café en Costa Rica?' : 'How to order coffee in Costa Rica?'}
                  </h4>
                  <ul className="text-xs text-emerald-100/90 text-left space-y-2">
        ...
        {activeSubTab === 'symbols' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Perezoso */}
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                <span className="text-4xl">🦥</span>
                <h4 className="text-xl font-black text-white">El Perezoso (Sloth)</h4>
                <span className="text-xs font-bold text-amber-400 block">Símbolo Nacional de la Fauna</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
              ...
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                ...
                <span className="text-xs font-bold text-amber-400 block">Ave Nacional de Costa Rica</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
              ...
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                ...
                <span className="text-xs font-bold text-amber-400 block">Patrimonio de la Humanidad (UNESCO)</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
              ...
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                ...
                <span className="text-xs font-bold text-amber-400 block">Flor Nacional (Guarianthe skinneri)</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
              ...
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                ...
                <span className="text-xs font-bold text-amber-400 block">Árbol Nacional (Enterolobium cyclocarpum)</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
              ...
              <div className="bg-[#092b1f] p-6 rounded-3xl border border-emerald-500/25 space-y-3">
                ...
                <span className="text-xs font-bold text-amber-400 block">Ave Sagrada del Bosque Nuboso</span>
                <p className="text-xs text-emerald-100/90 leading-relaxed">
                  {language === 'es'
        ...
        {activeSubTab === 'tips' && (
          <div className="space-y-6 animate-in fade-in duration-300 max-w-4xl mx-auto">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-[#092b1f] p-5 rounded-3xl border border-emerald-500/25 space-y-2">
