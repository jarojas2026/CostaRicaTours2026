...
2. Modifica o agrega un objeto de tipo `Tour` respetando estrictamente los campos oficiales:
   ...
   - `priceUSD`: Precio unitario por adulto en dólares americanos (el sistema calcula colones únicamente con el tipo de cambio configurado mediante `USD_TO_CRC_RATE`; no se debe incrustar una tarifa fija).
