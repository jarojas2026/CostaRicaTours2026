...
- **Counter Digital**: Widget y plataforma de atención 24/7 con soporte para chat en vivo, cotizaciones instantáneas en USD y, cuando `USD_TO_CRC_RATE` está configurado, en colones, captura de reservas y emisión de voucher QR.
